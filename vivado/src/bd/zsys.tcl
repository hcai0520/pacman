...
\
  ...
  connect_bd_net -net LEMO_A_0_1 [get_bd_ports LEMO_A_0] [get_bd_pins timing_unit_0/LEMO_A_I]
  connect_bd_net -net LEMO_B_0_1 [get_bd_ports LEMO_B_0] [get_bd_pins timing_unit_0/LEMO_B_I]
  ...
  connect_bd_net -net timing_unit_0_H_O [get_bd_pins timing_unit_0/H_O] [get_bd_ports TRIG_O_0]
